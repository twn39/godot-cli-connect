...
def get_project_logs(project_path: str, lines: int = 50) -> Dict[str, Any]:
    ...
    if sys.platform == "darwin":
        log_dir = os.path.expanduser(f"~/Library/Application Support/Godot/app_userdata/{safe_name}/logs")
    ...
    try:
        ...
        errors = [l for l in recent_lines if "ERROR" in l or "CRITICAL" in l or "SCRIPT ERROR" in l]
